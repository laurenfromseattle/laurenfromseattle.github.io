...
var projects = {
  projects : [{
    title : "Noob Notation",
    URL : "http://laurenfromseattle.github.io/blog/",
    dates : "Project started October 2015 and is ongoing",
    description : "A responsive web development blog built with Jekyll and hosted by GitHub Pages.",
    images : [
      "img/noob-notation-desktop-400x300.png",
      "img/noob-notation-mobile-400x300.png",
      "img/noob-notation-tablet-400x300.png"
    ]
  }
  ]
};
...
projects.display = function() {
  ...
  for (var i = 0; i < projectsArrayLength; i++) {
    ...
    //Appends formatted data to the last element with .project-entry as a class
    ...
    if (projects.projects[i].images.length > 0) {
      for (var j = 0; j < projects.projects[i].images.length; j++) {
        ...
        //Appends formatted data to the last .project-entry element
